  ...
  en: {
    ...
    sections: [
      ...
      ['What Stray’s Call does NOT do',
        'Stray’s Call does not sell your data, does not show targeted advertising, and does not process payments. If a vet shares bank details in a case chat, any payment happens directly between you and the clinic, outside Stray’s Call.'],
      ['Guest reports',
      ...
      ['Deleting your data',
        'You can delete your account and messages by contacting the Stray’s Call team; case reports may remain (anonymized) because they document an animal’s rescue history.'],
    ],
  },
  az: {
