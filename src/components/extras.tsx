...
const PRIVACY: Record<string, { title: string; sections: [string, string][] }> = {
  en: {
    ...
    sections: [
      ...
      ['What is public',
        'Case reports (photo, description, location, status) are public — that is the whole point: rescuers must be able to see them. Case group chats are also publicly readable. Your display name and level are public. Your email, exact home area, notification settings, and direct messages are not public.'],
  ...
  az: {
    ...
    sections: [
      ...
      ['Nə açıqdır',
        'Hadisə bildirişləri (foto, təsvir, yer, status) açıqdır — məqsəd elə budur: xilasedicilər onları görməlidir. Hadisə qrup çatları da açıq oxunur. Adınız və səviyyəniz açıqdır. E-poçtunuz, dəqiq əraziniz, bildiriş parametrləriniz və şəxsi mesajlarınız açıq deyil.'],
  ...
  tr: {
    ...
    sections: [
      ...
      ['Ne herkese açıktır',
        'Vaka bildirimleri (fotoğraf, açıklama, konum, durum) herkese açıktır — amaç zaten bu: kurtarıcılar onları görebilmeli. Vaka grup sohbetleri de herkese açık okunur. Adınız ve seviyeniz herkese açıktır. E-postanız, tam bölgeniz, bildirim ayarlarınız ve özel mesajlarınız herkese açık değildir.'],
