...
const TERMS: LocalizedDoc = {
  en: {
    ...
    intro:
      'Stray’s Call is a free tool that helps people find and coordinate help for injured street animals. By using it, you agree to these terms. We tried to keep them honest and readable rather than full of legal traps.',
    sections: [
      ...
      ['Your responsibilities',
        [
          ...
          'Money for an animal’s treatment is arranged directly between you and a vet clinic — never through Stray’s Call. We never touch, hold, or process payments.',
          'Don’t use Stray’s Call to harass, scam, defraud, impersonate, or endanger anyone.',
        ]],
      ['Vets and clinics',
      ...
      ['Content you post',
        'You keep ownership of your photos and messages, but grant Stray’s Call permission to display them within the app for coordination. Don’t post anything illegal, or anything you don’t have the right to share.'],
      ['Moderation and bans',
      ...
      ['No warranty; limits',
        'Stray’s Call is provided “as is,” with no guarantee it will be available, accurate, or that help will arrive. To the fullest extent the law allows, we aren’t liable for injuries, losses, or damages arising from using the app, coordinating a rescue, or dealing with an animal or another user.'],
      ['Changes',
        'We may update these terms as Stray’s Call grows. Material changes will be surfaced in the app. Continuing to use Stray’s Call means you accept the current terms.'],
      ['Contact',
  ...
  az: {
    ...
    intro:
      'Stray’s Call yaralı küçə heyvanlarına kömək tapmağa və əlaqələndirməyə kömək edən pulsuz vasitədir. Ondan istifadə etməklə bu şərtləri qəbul edirsiniz.',
    sections: [
      ...
      ['Sizin məsuliyyətiniz',
        [
          ...
          'Müalicə üçün pul birbaşa sizinlə klinika arasında razılaşdırılır — heç vaxt Stray’s Call vasitəsilə yox.',
          'Stray’s Call-dan təqib, fırıldaq, saxtakarlıq və ya təhlükə yaratmaq üçün istifadə etməyin.',
        ]],
      ...
      ['Paylaşdığınız məzmun',
        'Fotolarınızın və mesajlarınızın sahibliyi sizdə qalır, lakin Stray’s Call-a onları tətbiq daxilində göstərmək icazəsi verirsiniz. Qanunsuz heç nə paylaşmayın.'],
      ...
      ['Zəmanət yoxdur; məhdudiyyətlər',
        'Stray’s Call “olduğu kimi” təqdim olunur, onun əlçatan və ya dəqiq olacağına zəmanət yoxdur. Qanunun icazə verdiyi dərəcədə, tətbiqdən istifadədən yaranan zədə və ya itkilərə görə məsuliyyət daşımırıq.'],
      ['Dəyişikliklər',
        'Stray’s Call böyüdükcə bu şərtləri yeniləyə bilərik. Əhəmiyyətli dəyişikliklər tətbiqdə göstəriləcək.'],
      ['Əlaqə',
  ...
  tr: {
    ...
    intro:
      'Stray’s Call, yaralı sokak hayvanlarına yardım bulmaya ve koordine etmeye yardımcı olan ücretsiz bir araçtır. Kullanarak bu şartları kabul edersiniz.',
    sections: [
      ...
      ['Sorumluluklarınız',
        [
          ...
          'Tedavi parası doğrudan sizinle klinik arasında ayarlanır — asla Stray’s Call üzerinden değil.',
          'Stray’s Call’ı taciz, dolandırıcılık, sahtekârlık veya tehlike için kullanmayın.',
        ]],
      ...
      ['Paylaştığınız içerik',
        'Fotoğraflarınızın ve mesajlarınızın sahipliği sizde kalır, ancak Stray’s Call’a bunları uygulama içinde gösterme izni verirsiniz. Yasa dışı hiçbir şey paylaşmayın.'],
      ...
      ['Garanti yok; sınırlar',
        'Stray’s Call “olduğu gibi” sunulur, kullanılabilir veya doğru olacağına dair garanti yoktur. Yasaların izin verdiği ölçüde, uygulamayı kullanmaktan doğan yaralanma veya kayıplardan sorumlu değiliz.'],
      ['Değişiklikler',
        'Stray’s Call büyüdükçe bu şartları güncelleyebiliriz. Önemli değişiklikler uygulamada gösterilecektir.'],
      ['İletişim',
...
const SAFETY: LocalizedDoc = {
  en: {
    title: 'Safety Guide',
    intro:
      'Helping an injured animal is generous — and carries real physical risk. Please read this before your first rescue. Stray’s Call is a coordination tool, not a rescue or veterinary service; your safety is your own responsibility.',
    sections: [
      ['The real risks',
      ...
      ['This is your decision',
        'By accepting a rescue you accept these risks yourself. Stray’s Call, its team, and partner organizations are not liable for injury or loss from handling an animal.'],
    ],
  },
  az: {
    title: 'Təhlükəsizlik Bələdçisi',
    intro:
      'Yaralı heyvana kömək etmək comərdlikdir — və real fiziki risk daşıyır. İlk xilasetmədən əvvəl bunu oxuyun. Stray’s Call əlaqələndirmə vasitəsidir, xilasetmə xidməti deyil; təhlükəsizliyiniz öz məsuliyyətinizdir.',
    sections: [
      ['Real risklər',
      ...
      ['Bu sizin qərarınızdır',
        'Xilasetməni qəbul etməklə bu riskləri özünüz qəbul edirsiniz. Stray’s Call məsuliyyət daşımır.'],
    ],
  },
  tr: {
    title: 'Güvenlik Kılavuzu',
    intro:
      'Yaralı bir hayvana yardım etmek cömertçedir — ve gerçek fiziksel risk taşır. İlk kurtarmanızdan önce bunu okuyun. Stray’s Call bir koordinasyon aracıdır, kurtarma hizmeti değil; güvenliğiniz kendi sorumluluğunuzdadır.',
    sections: [
      ['Gerçek riskler',
      ...
      ['Bu sizin kararınız',
        'Bir kurtarmayı kabul ederek bu riskleri kendiniz kabul edersiniz. Stray’s Call sorumlu değildir.'],
    ],
  },
};
...
const CONDUCT: LocalizedDoc = {
  en: {
    ...
    intro: 'Stray’s Call only works if people trust each other. These rules keep it safe. Breaking them can get your content hidden or your account banned.',
    sections: [
      ...
      ['Fundraising rules — read this',
        [
          'Money for treatment goes DIRECTLY to a vet clinic, never through Stray’s Call.',
  ...
  az: {
    ...
    intro: 'Stray’s Call yalnız insanlar bir-birinə güvəndikdə işləyir. Bu qaydalar onu təhlükəsiz saxlayır. Onları pozmaq məzmununuzun gizlədilməsinə və ya hesabınızın bloklanmasına səbəb ola bilər.',
    sections: [
      ...
      ['Vəsait toplama qaydaları — bunu oxuyun',
        [
          'Müalicə üçün pul BİRBAŞA klinikaya gedir, heç vaxt Stray’s Call vasitəsilə yox.',
  ...
  tr: {
    ...
    intro: 'Stray’s Call yalnızca insanlar birbirine güvendiğinde çalışır. Bu kurallar onu güvende tutar. Bunları ihlal etmek içeriğinizin gizlenmesine veya hesabınızın yasaklanmasına yol açabilir.',
    sections: [
      ...
      ['Bağış toplama kuralları — bunu okuyun',
        [
          'Tedavi parası DOĞRUDAN kliniğe gider, asla Stray’s Call üzerinden değil.',
...
const ABOUT: LocalizedDoc = {
  en: { title: 'About Stray’s Call', sections: [
    ['Our mission', 'Stray’s Call exists so that no injured street animal dies simply because the people willing to help couldn’t find each other in time. We turn a scattered network of kind strangers, rescuers, and vet clinics into one fast, trustworthy chain: report → rescuer → verified vet.'],
    ['How it started', 'It began in Baku, where street-animal rescue already happens every day — but scattered across social media, drowning in duplicates, with no way to know if anyone actually went. Stray’s Call gives that goodwill a structure.'],
    ['Not-for-profit in spirit', 'We take no cut of anything. Money for treatment flows directly between people and clinics. Stray’s Call sustains itself through sponsorships and partnerships, never by charging the vulnerable or selling data.'],
  ...
  az: { title: 'Stray’s Call haqqında', sections: [
    ['Missiyamız', 'Stray’s Call ona görə mövcuddur ki, heç bir yaralı küçə heyvanı kömək etmək istəyənlər vaxtında bir-birini tapa bilmədiyi üçün ölməsin. Biz mehriban qəriblərin, xilasedicilərin və klinikaların dağınıq şəbəkəsini bir sürətli zəncirə çeviririk: bildiriş → xilasedici → təsdiqlənmiş baytar.'],
    ['Necə başladı', 'Bu, Bakıda başladı — küçə heyvanlarının xilası hər gün baş verir, lakin sosial mediada dağınıq şəkildə. Stray’s Call bu xoş niyyətə struktur verir.'],
    ['Ruhən qeyri-kommersiya', 'Biz heç nədən pay götürmürük. Müalicə pulu birbaşa insanlar və klinikalar arasında axır. Stray’s Call sponsorluq və tərəfdaşlıqlarla dolanır.'],
  ...
  tr: { title: 'Stray’s Call Hakkında', sections: [
    ['Misyonumuz', 'Stray’s Call, yardım etmeye istekli insanlar birbirini zamanında bulamadığı için hiçbir yaralı sokak hayvanı ölmesin diye var. Nazik yabancıların, kurtarıcıların ve kliniklerin dağınık ağını tek bir hızlı zincire dönüştürüyoruz: bildirim → kurtarıcı → onaylı veteriner.'],
    ['Nasıl başladı', 'Bakü’de başladı — sokak hayvanı kurtarma her gün oluyor ama sosyal medyada dağınık halde. Stray’s Call bu iyi niyete bir yapı kazandırıyor.'],
    ['Ruhen kâr amacı gütmeyen', 'Hiçbir şeyden pay almıyoruz. Tedavi parası doğrudan insanlar ve klinikler arasında akar. Stray’s Call sponsorluk ve ortaklıklarla ayakta durur.'],
...
const FAQ: LocalizedDoc = {
  en: { title: 'FAQ', sections: [
    ...
    ['Does Stray’s Call take money?', 'Never. We don’t process payments. Money for treatment is arranged directly between you and a vet clinic.'],
  ...
  az: { title: 'Tez-tez verilən suallar', sections: [
    ...
    ['Stray’s Call pul götürür?', 'Heç vaxt. Ödənişləri emal etmirik. Müalicə pulu birbaşa sizinlə klinika arasında razılaşdırılır.'],
  ...
  tr: { title: 'Sıkça Sorulan Sorular', sections: [
    ...
    ['Stray’s Call para alıyor mu?', 'Asla. Ödeme işlemiyoruz. Tedavi parası doğrudan sizinle klinik arasında ayarlanır.'],
