...
export const tr: Dict = {
  ...
  'home.filterRadiusAny': 'Herhangi bir mesafe',
  ...
  'caseChat.pinHint': 'Bir mesajı sabitleyebilirsiniz — örneğin bağışlar için banka bilgilerinizi — böylece bu sohbetin en üstünde kalır.',
