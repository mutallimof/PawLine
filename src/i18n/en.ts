...
export const en = {
  ...
  'caseChat.pinHint': 'Tap ⋯ on one of your own messages to pin it — e.g. your bank details for donations — so it stays at the top of this chat.',
  'caseChat.hintGotIt': 'Got it',
  'caseChat.close': 'Close chat',
  'caseChat.closeShort': 'Close',
  'caseChat.reopen': 'Reopen chat',
  'caseChat.closeConfirm': 'Close this chat? Nobody — you included — can post until you reopen it. Messages stay readable.',
  'caseChat.closedByClinic': 'The clinic closed this chat on {date}.',
  'caseChat.closedByYou': 'You closed this chat on {date}.',

  // Messages (DMs)
  'dm.title': 'Messages',
  'dm.empty': 'No conversations yet. To message a clinic, open it from Vets and tap “Message clinic”.',
  ...
  'dm.directTag': 'Direct',
  'dm.threadClosed': 'This conversation is closed. Direct messages are only between members and clinics.',
  'dm.messageClinic': 'Message clinic',
  ...
  'vetSetup.publicSection': 'Public contact',
  'vetSetup.clinicName': 'Clinic name',
  'vetSetup.address': 'Address',
  'vetSetup.phone': 'Phone',
  'vetSetup.contactPhone': 'Clinic phone',
  'vetSetup.contactEmail': 'Clinic email',
  'vetSetup.acceptedAnimals': 'Animals you accept',
  'vetSetup.privateSection': 'Manager contact',
  'vetSetup.privateSectionSub': 'Kept private — never shown on your public clinic page.',
  'vetSetup.managerName': 'Manager first name',
  'vetSetup.managerSurname': 'Manager last name',
  'vetSetup.managerPhone': 'Manager phone',
  'vetSetup.documents': 'Verification documents',
  ...
  'profile.rewardsSoon': 'Rewards & ranking — coming soon',
  ...
  'rating.prompt': 'How was your experience with {clinic}?',
  'rating.yourRating': 'Your rating',
  'rating.stars': '{n} stars',
  'rating.notePlaceholder': 'Anything else worth sharing? (optional)',
  'rating.submit': 'Submit rating',
  'rating.thanks': 'Thanks for rating your experience.',
  ...
  'admin.flaggedSub': 'Accounts with unusually many open reports against their content recently.',
  'admin.flaggedWindow': 'Last {n}d',
  'admin.flaggedCounts': '{reports} reports across {cases} cases',
  'admin.hiddenRatioTitle': 'High hidden-case ratio',
  'admin.hiddenRatioSub': 'Accounts whose own reports get hidden unusually often (at least 3 cases, 50%+ hidden).',
  'admin.hiddenRatioCounts': '{pct}% hidden ({hidden} of {total} cases)',
  'admin.highVolumeTitle': 'High-volume reporters',
  'admin.highVolumeSub': 'Accounts currently at or above the case-creation rate limit (4/hour or 7/24h).',
  'admin.highVolumeCounts': '{hour} in the last hour · {day} in the last 24h',
  'admin.viewProfile': 'View profile',
  'admin.flagConfirm': 'Hide every case {name} created and ban this account? This cannot be easily undone.',
  'admin.flagAction': 'Hide cases & ban',
  ...
  'report.nearbyTitle': 'There’s already an open case nearby',
  'report.nearbyBody': 'Could this be the same animal? Either way, your report will still be sent.',
  'report.nearbySame': 'It’s the same one',
  'report.nearbyDifferent': 'Different animal, continue',
  ...
  'admin.dms': 'DMs',
  'admin.dmsSub': 'Every direct-message thread, newest activity first. Read-only — admins can’t post.',
  'admin.dmsBack': 'All threads',
  'admin.dmsReadOnly': 'Read-only. You can ban either side; you can’t post here.',
  'admin.dmsNoMessages': 'No messages in this thread yet.',
  'admin.dmsCount': '{n} messages',
  ...
  'admin.users': 'Users',
  'admin.usersCommunity': 'Community',
  'admin.usersVets': 'Vets',
  'admin.usersSearch': 'Search',
  'admin.usersSearchPlaceholder': 'Name or email',
  'admin.sortBy': 'Sort by',
  'admin.sortJoined': 'Newest',
  'admin.sortRescues': 'Rescues',
  'admin.sortXp': 'XP',
  'admin.usersNone': 'No accounts match.',
  'admin.usersLoadMore': 'Load more',
  'admin.usersBack': 'All users',
  'admin.roleUser': 'Community member',
  'admin.roleVet': 'Vet',
  'admin.badgeAdmin': 'Admin',
  'admin.badgeBanned': 'Banned',
  'admin.metaXp': '{n} XP',
  'admin.metaRescues': '{n} rescues',
  'admin.colXp': 'XP',
  'admin.colRescues': 'Rescues',
  'admin.colReported': 'Cases reported',
  'admin.colHidden': 'Cases hidden',
  'admin.colJoined': 'Joined',
  'admin.unbanUser': 'Unban user',
  'admin.userBanConfirm': "Ban {name}? They won't be able to post, message or report until unbanned.",
  'admin.unhide': 'Unhide',
  'admin.hiddenContentTitle': 'Hidden content',
  'admin.clinicTitle': 'Clinic',
  'admin.clinicNone': 'No clinic registered yet.',
  'admin.vetStatus.pending': 'Pending review',
  'admin.vetStatus.approved': 'Approved',
  'admin.vetStatus.rejected': 'Rejected',
  'admin.vetBackToReview': 'Back to review',
  'admin.vetRejectConfirm': 'Reject {name}? The clinic is notified and will not appear to rescuers.',
  'admin.vetUnapproveConfirm': 'Move {name} back to review? It disappears from the rescuer directory until approved again.',
  'admin.chartsTitle': 'Growth',
  'admin.chartDaily': 'Daily',
  'admin.chartWeekly': 'Weekly',
  'admin.chartSignups': 'Signups',
  'admin.chartCases': 'New cases',
  'admin.chartWeekOf': 'Week of {date}',
  'admin.chartLastDays': 'last {n} days',
  'admin.chartLastWeeks': 'last {n} weeks',
  ...
  'vets.hoursTitle': 'Opening hours',
  'vets.hours247': 'Open 24/7',
  'vets.hoursOvernight': 'overnight',
  'vets.hoursNotSet': 'Hours not set',
  'vets.openNow': 'Open now',
  'vets.hoursTz': 'Clinic’s local time ({tz})',
